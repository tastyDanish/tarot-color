      ...
      <div className="max-w-120 flex flex-col gap-4 pt-0 md:pt-2">
        ...
        <div className="w-full px-4 md:px-0">
          {loading ? (
            ...
            <button
              className="bg-orange-100 py-4 rounded-md text-green-900 flex flex-col items-center gap-2 justify-around shadow-md hover:shadow-lg transition cursor-pointer relative w-full overflow-hidden"
