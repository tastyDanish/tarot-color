...
export const TAROT_CARDS: TarotCard[] = [
  ...
  },
  {
    ...
    description:
      "wealth, opulence, sumptuousness, magnificence, radiance, luster, luxury, abundance, goods",
  },
  {
    name: "Four Of Cups",
  ...
  },
  {
    ...
    description:
      "Achievement, success, accomplishment, happy outcome, victory, healing, cure, relief, perfection",
  },
  {
