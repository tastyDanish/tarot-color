...
const LittleCard = (props: { rotation: string }) => {
  return (
    <div
      className={cn(
        "border-2 border-green-900 shadow-2xl rounded-sm",
        props.rotation
      )}>
      <div className="w-18 h-28 border-4 border-orange-100 bg-green-950 relative overflow-hidden flex justify-center items-center">
